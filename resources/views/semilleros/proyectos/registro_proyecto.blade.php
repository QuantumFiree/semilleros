<x-applayout>
    ...
    <div class=" flex flex-col w-full items-center " style="background-color: #f8f8f8">
        <div class=" mt-6 px-6 py-4 shadow-2xl overflow-hidden sm:rounded-lg" style="background-color: #bcd9c8">
            <x-slot name="logo">
            </x-slot>

            <form method="POST" action="{{ route('registro.proyecto') }}" enctype="multipart/form-data" class="flex justify-center">
                <div>
                    @csrf
