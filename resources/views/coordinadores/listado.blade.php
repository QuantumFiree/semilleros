                        ...
                        <table class="table text-gray-400 border-separate space-y-6 text-sm">
                            <thead>
                                <tr class="bg-gray-700 text-green-400">
                                    ...
                                    <th class="p-3 text-left">Acuerdo</th>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-gray-700">
                                    <td class="p-3">
                                        <div class="flex align-items-center">
                                            <div class="ml-3">
                                                <h1 class="text-gray-200">{{$coordinador->nombres}}
                                                    {{$coordinador->apellidos}}
</h1>
                                           <h1 class="text-gray-200">{{$coordinador->cod_coordinador}}</h1>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-3">
                                        <div class="flex align-items-center">
                                            <div class="ml-4">
                                                ...
                                                <a data-bs-toggle="modal" data-bs-target="#{{$coordinador->cod_docente}}" href="#" class="text-amber-500 hover:text-gray-100 mr-2">
                                    ...
                                    <td class="p-3">
                                        ...
                                        <span class="bg-green-400 text-gray-50 rounded-md px-2">{{$coordinador->estado}}</span>
                                        @elseif($coordinador->estado == 'pendiente')
                                        <span class="bg-yellow-500 text-gray-50 rounded-md px-2">{{$coordinador->estado}}</span>
                                        @else
                                        <span class="bg-red-500 text-gray-50 rounded-md px-2">{{$coordinador->estado}}</span>
                                        @endif
                                    </td>
                                    <td class="p-3 ">
                                        <a data-bs-toggle="modal" data-bs-target="#{{$coordinador->cod_coordinador}}" href="#" class="text-gray-400 hover:text-gray-100 mr-2">
                                            <i class="material-icons-outlined text-base">visibility</i>
                                        </a>
                                        <a href="{{route('perfilCoordinadorView', ['cod_coordinador' => $coordinador->id])}}" class="text-gray-400 hover:text-gray-100  mx-2">
                                            <i class="material-icons-outlined text-base">edit</i>
                                        </a>
                                        
                                        <a href="{{route('eliminarCoordinador', ['cod_coordinador' => $coordinador->cod_coordinador])}}" type="" class="text-gray-400 hover:text-red-500  ml-2"><i class="material-icons-round text-base">delete_outline</i></a>


                                    </td>
                                </tr>
                                <div class="modal fade" id="{{$coordinador->cod_coordinador}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-gray-700">
                                                ...
                                                <h2 class="mb-2 text-lg font-extrabold text-gray-100 text-center">{{$coordinador->nombres}} {{$coordinador->apellidos}}</h2>
                                                <div class="flex w-full justify-center mb-3">
                                                    @if($coordinador->profile_photo_path)
                                                    <img class="h-24 w-24 rounded-full object-cover" src="{{ asset('storage/' . $coordinador->profile_photo_path) }}" alt="{{ $coordinador->nombres }}" />
                                                    @else
                                                ...
                                                <div class="flex mt-3">
                                                    ...
                                                    <ul class="max-w-md space-y-1 list-none list-inside dark:text-gray-200 w-1/2 pl-1">
                                                        ...
                                                        <li class="flex justify-start space-x-5">
                                                            <p class="text-gray-200">
                                                                {{$coordinador->fecha_vinculacion}}
                                                            </p>
                                                        </li>
                                                        <li class="flex justify-start space-x-5">
                                                            <p class="text-gray-200">
                                                                {{$coordinador->area_conocimiento}}
                                                            </p>
                                                        </li>
                                                        <li class="flex justify-start space-x-5">
                                                            <p class="text-gray-200">
                                                                {{$coordinador->cod_docente}}
                                                            </p>
                                                        </li>
                                                        <li class="flex justify-start space-x-5">
                                                            <p class="text-gray-200">
                                                                {{$coordinador->nombre_programa}}
                                                            </p>
                                                        </li>
                                                        <li class="flex justify-start space-x-5">
                                                            <p class="text-gray-200">
                                ...
                                <div class="modal fade" id="{{$coordinador->cod_docente}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                @endif
                                                <h1 class="font-extrabold text-lg text-center w-full" id="2{{$coordinador->cod_coordinador}}">Acuerdo nombramiento</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                                    </svg>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <embed src="{{ asset('storage/' . $coordinador->acuerdo_nombramiento) }}" type="application/pdf" width="100%" height="500px">
                                            </div>
                                        </div>
